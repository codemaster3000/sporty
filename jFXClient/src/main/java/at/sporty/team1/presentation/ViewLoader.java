...
import at.sporty.team1.presentation.controllers.NewMemberController;
...
public class ViewLoader<T extends IJfxController> {
	...
	static {
		...
		_viewPaths.put(NewMemberController.class, "/at/sporty/team1/presentation/views/NewMemberView.fxml");
	}
