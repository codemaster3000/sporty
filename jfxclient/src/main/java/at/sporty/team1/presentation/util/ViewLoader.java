...
public class ViewLoader<T extends IJfxController> {
	...
	static {
		...
		_viewPaths.put(MatchEditViewController.class, "/at/sporty/team1/presentation/views/MatchEditView.fxml");
		_viewPaths.put(CompetitionEditViewController.class, "/at/sporty/team1/presentation/views/CompetitionEditView.fxml");
