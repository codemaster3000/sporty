    ...
    public boolean isValid(String value, DataType type) throws PatternSyntaxException {
        ...
        switch (type) {
            ...
            case USERNAME: {
                ...
                return !isNullOrEmpty(value) && value.length() >= 1 && expr.matches(value);
            }
            ...
            case DAY_DATE: {
                ...
                return isNullOrEmpty(value) || value.length() <= 10 && expr.matches(value);
            }
            ...
            case SQL_DATE: {
                ...
                return  isNullOrEmpty(value) || value.length() == 10 && expression.matches(value);
            }
            ...
            case NAME: {
                ...
                return isNullOrEmpty(value) || value.length() <= 100 && expr.matches(value);
            }

            case INTEGER_TYPE: {
                RegularExpression expr = new RegularExpression("[0-9]{0,11}");
                lastFailedValidation = DataType.INTEGER_TYPE;
                return isNullOrEmpty(value) || value.length() <= 11 && expr.matches(value);
            }
            ...
            case SIN: {
                ...
                return isNullOrEmpty(value) || value.length() <= 66 && expr.matches(value);
            }
            ...
            case PHONE_NUMBER: {
                ...
                return isNullOrEmpty(value) || value.length() >= 4 && expr.matches(value);
            }
            ...
            case STREET_NUMBER: {
                ...
                return isNullOrEmpty(value) || value.length() >= 1 && value.length() <= 30;
            }
